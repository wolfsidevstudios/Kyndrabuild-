...
import type { ChatMessage, HistoryEntry, DeployState, KyndraDeployState, Project, AttachmentContext } from '../../App';
...
interface WorkspaceProps {
  ...
  onAttachFile: (attachment: { type: 'file', data: { name: string, url: string } }) => void;
...
const Workspace: React.FC<WorkspaceProps> = (props) => {
    ...
    switch(activeTool) {
        ...
        case 'image':
            return <ImageGeneratorPanel onAttach={(name, url) => props.onAttachFile({ type: 'file', data: { name, url }})} />;
        case 'settings':
